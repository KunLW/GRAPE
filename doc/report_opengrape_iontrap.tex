...
\end{align}
\begin{notebox}
There exists global phase of bichromatic laser because this ``global'' is just global through the spin space. Since the system is considering the interaction between the motion and spin, this ``global'' phase is actually the phase difference between motion phase and laser phase. 
\end{notebox}
