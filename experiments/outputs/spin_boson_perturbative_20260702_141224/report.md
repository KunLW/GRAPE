...
Generated at: 2026-07-02T14:12:24
...
| Parameter | Value |
| --- | --- |
| experiment_dir | spin_boson_perturbative_20260702_141224 |
...
| Metric | Value |
| --- | --- |
| initial_penalized_objective | 0.973306937681 |
| initial_raw_fidelity | 0.98010655368 |
| initial_close_gate_fidelity | 0.98118524305 |
| initial_open_gate_fidelity | 0.98010655368 |
...
| --- | --- | --- |
| kappa_1 | 21.3047161154 | max_boundary_corner dt * \|\|H_nominal(alpha)\|\|_2 over alpha bounds |
| kappa_2 | 1.4896802752 | max_boundary_corner T * \|\|H_fluctuation(alpha)\|\|_2 over alpha bounds; fluctuation terms are already scaled |
| kappa_1_corner | 3 | boundary corner attaining max \|\|H_nominal\|\|_2 |
| kappa_2_corner | 0 | boundary corner attaining max \|\|H_fluctuation\|\|_2 |
| kappa_1_alpha | (3769911.1843077517, 125663.70614359171) | alpha values at kappa_1 corner in rad/s |
| kappa_2_alpha | (6283.185307179586, 0.0) | alpha values at kappa_2 corner in rad/s |
| kappa_1_h_norm | 18870430.5717 | max \|\|H_nominal\|\|_2 |
| kappa_2_h_fluc_norm | 6597.344 | max \|\|H_fluctuation\|\|_2 |
...
| control[0] | 0.0 | kron(I_spin, number_operator) | alpha1(t) * control[0] | 24x24 | 0 | 0 | True |
| control[1] | 0.0 | kron(S_phi(mode=(0.5, -0.5)), a + adag) | alpha2(t) * control[1] | 24x24 | 0 | 0 | True |

## System Construction Script

```python
phi_s = 0.0
system = spin_boson_control_system(n_levels=6, phi_s=phi_s)
...
| --- | --- | --- | --- |
| single_state_fidelity | 0.979930842651 | 0.999959766 | 0.0200289233486 |
| close_gate_fidelity | 0.98118524305 | 0.999969395223 | 0.0187841521731 |
| open_gate_fidelity | 0.98010655368 | 0.99883099847 | 0.01872444479 |
| l1_penalty | 0.00679953120153 | 0.0066525211328 | -0.000147010068726 |
| l2_penalty | 8.47980269926e-08 | 1.27692622738e-06 | 1.19212820039e-06 |
| penalized_objective | 0.973306937681 | 0.992177200411 | 0.0188702627305 |
