...
- `label`: sweep_20260701_141220_sigmaT_no_mc
...
| truncation | mc_exact_fidelity | 0.25 |  | False | mc_samples <= 0 |
| truncation | abs_perturbative_minus_mc | 0.25 |  | False | mc_samples <= 0 |
...
| truncation | mc_exact_fidelity | 0.5 |  | False | mc_samples <= 0 |
| truncation | abs_perturbative_minus_mc | 0.5 |  | False | mc_samples <= 0 |
...
| truncation | mc_exact_fidelity | 1.0 |  | False | mc_samples <= 0 |
| truncation | abs_perturbative_minus_mc | 1.0 |  | False | mc_samples <= 0 |
